...
<body>
 <div class="form-container">
        <h2>Add Employee</h2>
        <form action="${pageContext.request.contextPath}/employees?action=save" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="vacationDays" name="vacationDays" required />
            </div>

            <div class="form-group">
                <label for="vacationTaken">Vacation Taken:</label>
                <input type="number" id="vacationTaken" name="vacationTaken" value="0" readonly />
            </div>
